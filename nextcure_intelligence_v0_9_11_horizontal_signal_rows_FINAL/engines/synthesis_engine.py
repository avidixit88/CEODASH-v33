    ...
    return pd.DataFrame([
        {
            ...
            "v0.9.3 Status": "Roadmap only; no live ingestion claimed.",
        },
        {
            ...
            "v0.9.3 Status": "Schema planned; future ingestion lane.",
        },
        {
            ...
            "v0.9.3 Status": "Candidate for next manual-to-automated bridge.",
        },
    ])
